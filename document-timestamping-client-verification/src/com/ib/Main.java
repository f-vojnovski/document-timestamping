...
public class Main {
    ...
    private static final String signatureHex = "PASTE_SIGNATURE_HERE";
    private static final String keyString = "PASTE_PUBLIC_KEY_HERE";
    private static final String targetHash = "PASTE_TARGET_HASH_HERE";
