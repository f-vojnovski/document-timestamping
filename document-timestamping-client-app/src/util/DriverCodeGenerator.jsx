export default function generateDriverCode(signatureHex, pk, targetHash, signatureAlgorithm, timestamp) {
...
public class Main {
    ...
    private final static String signatureAlgorithm = "${signatureAlgorithm || "SHA512withRSA"}";
    private final static String signatureHex = "${signatureHex}";
    private final static String keyString = "${pk}";
    private final static String targetHash = "${targetHash}";
